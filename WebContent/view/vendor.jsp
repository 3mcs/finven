										...
										<div class="tab-pane active" id="tab1">
												...
												<span id="vendorProfileSpan">
													<div class="ColumnCommonSingletwo">
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" id="personalvenfirstname" data-mandatory="Y" placeholder="First Name" name="firstname" class="m-wrap large" onblur="validateNotNull(this, 'vendorProfileFirstNameErrorMsg')" value="${vendor.firstName}"/>
																<div><label id="vendorProfileFirstNameErrorMsg" class="errorMessage"></label></div>
															</div>
														</div>
														<div class="control-group">
														...
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" id="personalvendesignation" data-mandatory="Y" placeholder="Designation" name="designation" class="m-wrap large" onblur="validateWithRegularExpression(this, 'vendorProfileDesignationErrorMsg', regularExpressionMap['DESIGNATION'], 'DESIGNATION', true)" value="${vendor.designation}"/>
																<div><label id="vendorProfileDesignationErrorMsg" class="errorMessage"></label></div>
															</div>												
														</div>
														<div class="control-group">
															<label class="control-labelalign">Company<span class="required">*</span></label>
															<div class="controls">
																<input type="text" id="personalvencompany" data-mandatory="Y" placeholder="Company" name="company" class="m-wrap large" onblur="validateNotNull(this, 'vendorProfileCompanyErrorMsg')" value="${vendor.company}"/>
																<div><label id="vendorProfileCompanyErrorMsg" class="errorMessage"></label></div>
															</div>
														</div>
														<div class="control-group">
															<label class="control-labelalign">Company URL<span class="required">*</span></label>  
															<div class="controls">
																<input type="text" id="personalvencompanyurl" data-mandatory="Y" placeholder="Company URL" name="companyurl" class="m-wrap large" onblur="validateWithRegularExpression(this, 'vendorProfileCompanyURLErrorMsg', regularExpressionMap['URL'], 'COMPANY_URL', true)" value="${vendor.company_url}"/>
																<div><label id="vendorProfileCompanyURLErrorMsg" class="errorMessage"></label></div>
															</div>
														</div>
														<div class="control-group">
															<label class="control-labelalign">Company Information<span class="required">*</span></label>
															<div class="controls">
																<textarea id="personalvencompanyinfo" data-mandatory="Y" placeholder="Company Information" name="companyinfo" class="m-wrap large" cols="30" rows="5" onblur="validateNotNull(this, 'vendorProfileCompanyInfoErrorMsg')">${vendor.company_info}</textarea>
																<div><label id="vendorProfileCompanyInfoErrorMsg" class="errorMessage"></label></div>
															</div>
														</div>											
													</div>
													<div class="ColumnCommonSingletwopersonalinfo">
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" id="personalvenprimemail" data-mandatory="Y" placeholder="Primary Email" name="primaryemail" class="m-wrap large"  onblur="if (validateWithRegularExpression(this, 'vendorProfilePrimaryEmailErrorMsg', regularExpressionMap['EMAIL'], 'EMAIL', true)) validateAjax(this, 'checkExistingEmail','vendorProfilePrimaryEmailErrorMsg')" value="${vendor.email}"/>
																<div><label id="vendorProfilePrimaryEmailErrorMsg" class="errorMessage"></label></div>
															</div>
														</div>
														<div class="control-group">
															<label class="control-labelalign">Secondary Email</label>
															<div class="controls">
																<input type="text" id="personalvensecemail" placeholder="Secondary Email" name="secondaryemail" class="m-wrap large"  onblur="if (validateWithRegularExpression(this, 'vendorProfileSecondaryEmailErrorMsg', regularExpressionMap['EMAIL'], 'EMAIL', false)) validateAjax(this, 'checkExistingEmail','vendorProfileSecondaryEmailErrorMsg')" value="${vendor.secondary_email}"/>
																<div><label id="vendorProfileSecondaryEmailErrorMsg" class="errorMessage"></label></div>
															</div>
														</div>
														<div class="control-group">
															<label class="control-labelalign">Phone Number<span class="required">*</span></label>
															<div class="controls">
																<input type="text" id="personalvenphonenumbervalue" data-mandatory="Y" placeholder="Code" name="phonenumber" class="m-wrap smallic" onblur="validateWithRegularExpression(this, 'vendorProfilePhoneNumberCodeErrorMsg', regularExpressionMap['PHONE_CODE'], 'PHONE_CODE', true)"/>
																<input type="text" id="personalvenphonenumber" data-mandatory="Y" placeholder="Phone Number" name="phonenumber" class="m-wrap largephonenumber"  onblur="validateWithRegularExpression(this, 'vendorProfilePhoneNumberErrorMsg', regularExpressionMap['PHONE_NUMBER'], 'PHONE', true)" value="${vendor.telephone}"/>
																<div class="selectOptions">e.g. +91 9869190000</div>														
																<div><label id="vendorProfilePhoneNumberCodeErrorMsg" class="errorMessage"></label></div>
																<div><label id="vendorProfilePhoneNumberErrorMsg" class="errorMessage"></label></div>
															</div>													
														</div>
														<div class="control-group">
															<label class="control-labelalign">Region of Incorporation<span class="required">*</span></label>
															<div class="controls">
																<select name="personalvenregionofincorp" id="personalvenregionofincorp" data-mandatory="Y" style="width:200px">
															     	<option value ="-SELECT-" class="selectvalues">-SELECT-</option>
																     <c:forEach var="regions" items="${regions}">
																    	<option value="${regions.name}">${regions.name}</option>
																 	 </c:forEach>
															 	</select>
															 	<div><label id="vendorProfileRegionOfIncorpErrorMsg" class="errorMessage"></label></div> 
															</div>
													 	</div>
														<div class="control-group">
															<label class="control-labelalign">Country of Incorporation<span class="required">*</span></label>
															<div class="controls">
																<select name="personalvencountryofincorp" id="personalvencountryofincorp" data-mandatory="Y" style="width:200px">
																     <option value ="-SELECT-" class="selectvalues">-SELECT-</option>
																     <c:forEach var="countries" items="${countries}">
																	    <option value="${countries.name}">${countries.name}</option>
																	  </c:forEach>
														   		</select>
														   		<div><label id="vendorProfileCountryOfIncorpErrorMsg" class="errorMessage"></label></div> 
															</div>
														</div>
														<div class="control-group">
											...
											<div><br/> </div>
												...
												<div class="se" style="padding-left: 177px;">
													<a class="btn" data-toggle="tab" class="step" onclick="validateSpanElements('vendorProfileSpan');updateVendorPersonalInfo();">Update</a>
