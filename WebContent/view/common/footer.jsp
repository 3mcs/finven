	...
	<div class="footer" id="footer">
			<div class="footer-left-wrap">
				...
				<ul class="send-ul">
					...
					<li><a href="#"><font style="font-weight:bold"><b>Sitemap</b></font></a></li>
					<li><a href="#"><font style="font-weight:bold"><b>Privacy Policy</b></font></a></li>
					<li><a href="#"><font style="font-weight:bold"><b>Advertise</b></font></a></li>
					<li><a href="#"><font style="font-weight:bold"><b>Disclaimer</b></font></a></li>
				</ul>
			</div>
